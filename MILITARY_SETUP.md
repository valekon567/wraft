...
**🔒 БЕЗПЕКА**: Дефолтний пароль `Military2025!` використовується тільки для демонстрації. 
Для production середовища:
1. Змініть паролі всіх користувачів одразу після створення
2. Використовуйте складні паролі (мінімум 16 символів)
3. Налаштуйте примусову зміну паролю при першому вході
4. Розгляньте впровадження двофакторної аутентифікації
